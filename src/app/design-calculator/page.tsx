...
import { ArrowRight, Search, Settings2, Zap, LayoutGrid } from "lucide-react";
...
export default function DesignCalculatorLanding() {
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 py-12 md:py-20 space-y-20">
      {/* Hero Section */}
      <div className="text-center space-y-6" style={{ animation: "heroFadeUp 0.5s cubic-bezier(0.25, 0.46, 0.45, 0.94) both" }}>
