  ...
  return (
    <section id="tech" className="py-32 px-6 bg-white overflow-hidden">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="max-w-5xl mb-24" data-animate>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 mb-40" data-animate-stagger>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center py-24 px-12 bg-bg-main rounded-[48px] border border-border-subtle" data-animate>
          <div>
