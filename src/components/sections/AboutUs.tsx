    ...
    <section id="about" className="py-32 px-6 bg-white overflow-hidden">
      <div className="max-w-7xl mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-24 items-center">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-6" data-animate-stagger>
            {[
              { icon: Cpu, title: "In-house R&D", desc: "Rapid prototyping and advanced power architecture design." },
              { icon: Shield, title: "Compliance Ready", desc: "Alignment with global IEC and SAE engineering standards." },
              { icon: Zap, title: "Tier-1 Support", desc: "Enterprise-grade support for complex OEM programs." },
              { icon: Share2, title: "Scalable Output", desc: "Production delivery from pilot builds to high volumes." }
            ].map((feature, i) => (
              <div
                key={i}
